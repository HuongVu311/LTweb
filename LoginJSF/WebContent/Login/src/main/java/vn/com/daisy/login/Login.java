...
public class Login implements Serializable {
	...
	*/
	...
	public String validateUsernamePassword() throws IOException {
		...
		String dataExport = null;
		if(userName.equals("khanhkaka") && password.equals("chutrongkhanh"))
			isValid = true;
		else
			isValid = false;		
		if (isValid) {
			...
			SessionBean.getResponse().setCharacterEncoding("UTF-8");
			PrintWriter out = SessionBean.getResponse().getWriter();
			dataExport = "Tài khoản này không tồn tại hoặc mật khẩu, tài khoản không đúng";
			out.println("<font color=red>"+dataExport+"</font> ");
